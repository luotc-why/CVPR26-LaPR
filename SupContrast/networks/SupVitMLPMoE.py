...
class SupVitMLPMoE(nn.Module):
    ...
    def __init__(self, name='vit_large_patch14_clip_224', data_base_path = '/data1/liyusheng/CVPR-LRKL/Data', feat_dim=512, K=1, head_type='mlp', router_hidden=256, router_topk=3, router_temperature=1, router_power=2, router_beta=1e-2):
