...
class MaskedAutoencoderViT(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3,
                 ...
                 mlp_ratio=4., norm_layer=nn.LayerNorm, vq_base_dir = '.'):
        super().__init__()
        ...
        self.vae = get_vq_model(vq_ckpt_dir=vq_base_dir).eval()
...
def mae_vit_small_patch16(vq_base_dir='.',**kwargs):
    model = MaskedAutoencoderViT(
        patch_size=16, embed_dim=384, depth=12, num_heads=12,
        decoder_embed_dim=512, decoder_depth=8, decoder_num_heads=16,
        mlp_ratio=4, norm_layer=partial(nn.LayerNorm, eps=1e-6), vq_base_dir=vq_base_dir,  **kwargs)
    return model


def mae_vit_base_patch16_dec512d8b(vq_base_dir='.',**kwargs):
    model = MaskedAutoencoderViT(
...
def mae_vit_large_patch16_dec512d8b(vq_base_dir='.',**kwargs):
    model = MaskedAutoencoderViT(
...
def mae_vit_huge_patch14_dec512d8b(vq_base_dir='.', **kwargs):
    model = MaskedAutoencoderViT(
