...
# [1]
python tools/featextrater_folderwise_SupMoEPR_XY.py vit_large_patch14_clip_224.laion2b features_supcon-vit-laion2b-clip-csz224-bsz64-lr0005-freeze-encoder trn ${data_root} 0.005 ckpt_epoch_200 0 "0,1,2,3" 
python tools/featextrater_folderwise_SupMoEPR_XY.py vit_large_patch14_clip_224.laion2b features_supcon-vit-laion2b-clip-csz224-bsz64-lr0005-freeze-encoder val ${data_root} 0.005 ckpt_epoch_200 0 "0,1,2,3" 

# [2]
python tools/calculate_similariity_SupMoE_XY.py features_supcon-vit-laion2b-clip-csz224-bsz64-lr0005-freeze-encoder val trn ${data_root} 0.005 ckpt_epoch_200 0 "0,1,2,3" 
