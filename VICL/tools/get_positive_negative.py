...
inference_result_root = f'{data_base_path}/output_seg_images/final_corrert_output_seg_images'



for fold_id in range(4):
    cur_dir = os.path.join(inference_result_root, f'{output_name}_folder{fold_id}/log.txt')
