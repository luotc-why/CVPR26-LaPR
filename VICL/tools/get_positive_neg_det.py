...
inference_result_root = '/data1/liyusheng/CVPR-LRKL/Codes/VICL/output_det_images/corrert_vicl_performance/output_vit-laion2b-clip_trn_0'
...
with open('/data1/liyusheng/CVPR-LRKL/Codes/VICL/output_det_images/corrert_vicl_performance/output_vit-laion2b-clip_trn_0/log.txt') as f:
    metas = f.readlines()
