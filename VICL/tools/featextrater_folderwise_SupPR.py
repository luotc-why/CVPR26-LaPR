...
save_dir = f"{data_base_path}/figures_dataset/pascal-5i/VOC2012/{feature_name}_{split}"
...
# for folder_id in tqdm([0, 1, 2, 3]):
    ...
    ckpt_path = f"{data_base_path}/save/SupCon/path_models/SupCon_path_{pretrain_name}_folder_{folder_id}_seed_0_lr_0.005_decay_0.0001_cropsz_{size}_bsz_64_temp_0.1_trial_0_cosine_pretrain-vit-freeze-encoder/last.pth"
    try:
