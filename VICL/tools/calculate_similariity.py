...
sys.stdout.flush()
source_features_dir = f"{data_base_path}/figures_dataset/pascal-5i/VOC2012/{features_name}_{source_split}"
target_features_dir = f"{data_base_path}/figures_dataset/pascal-5i/VOC2012/{features_name}_{target_split}"
