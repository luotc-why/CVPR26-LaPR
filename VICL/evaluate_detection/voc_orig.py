...
class VOCDetection(VisionDataset):
    ...
    def __init__(self,
        ...
        # self.val_flattened_set = torch.load('/data1/liyusheng/CVPR-LRKL/Data/figures_dataset/pascal-5i/2012_val_flattened_set.pth')
        self.root = root
...
if __name__ == '__main__':
    val_ds = VOCDetection('/data1/liyusheng/CVPR-LRKL/Data/figures_dataset/pascal-5i', ['2012'], image_sets=['train'], transforms=None)
    print(len(val_ds))