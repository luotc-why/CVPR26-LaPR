...
class DatasetPASCAL(Dataset):
    def __init__(self, datapath, fold, split, image_transform, mask_transform, top_50_path, padding: bool = 1, use_original_imgsize: bool = False, flipped_order: bool = False,
    ...
    def get_top50_images_val(self):
        ...
        # with open(f"/data1/liyusheng/CVPR-LRKL/Data/figures_dataset/pascal-5i/VOC2012/features_supcon-vit-laion2b-clip-csz224-bsz64-lr0005-freeze-encoder_val_MoE_specicalused/folder{self.fold}_top50-similarity.json") as f:
    ...
    def extract_ignore_idx(self, mask, class_id, purple: bool = False):
        mask = np.array(mask)
